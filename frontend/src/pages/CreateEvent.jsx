...
function CreateEvent() {
  ...
  const handleSubmit = async (e, statusOverride) => {
    ...
    // Validate Base
    if (!formData.eventName || !formData.eventDescription || !formData.registrationDeadline ||
      !formData.startDate || !formData.endDate || !formData.registrationLimit || !formData.venue) {
